...
const faqs = [
...

  {
    ...
    data: [
      ...
      {
        title:
          "Do you provide transportation for corporate events or conferences",
      ...
      {
        title:
          "How does ME CABS ensure a professional experience for corporate clients?",
      ...
      <section className="faq py-[100px]">
        <div className="container">
          <div className="max-w-screen-xl mx-auto">
            <div className="bg-white lg:px-6 px-3">
              ...
              <div className="w-full mx-auto">
                <Tabs
                  ...
                  className="w-full lg:flex lg:gap-5 lg:justify-start"
                >
                  <TabsList className="lg:flex-[1_1_200px] w-full lg:flex-col lg:justify-center justify-start lg:h-fit h-16 overflow-x-auto lg:bg-white lg:shadow lg:p-3">
                    {faqs.map((faq) => (
                      <TabsTrigger
                        key={faq.type}
                        value={faq.type}
                        className="capitalize h-12  lg:w-full lg:justify-start"
                      >
                        {faq.type.replace("-", " ")}
                      </TabsTrigger>
                    ))}
                  ...
                  {selectedFaq && (
                    <TabsContent className="lg:flex-[8_1_500px] bg-white shadow lg:mt-0 rounded-xl p-5" value={selectedFaq.type}>
