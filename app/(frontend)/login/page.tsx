...
export default function LoginPage() {
  return (
    <>
      <section
        style={{ backgroundImage: ` url(${signbg.src})` }} className="bg-zinc-100 w-full py-[100px] h-[calc(100vh_-_71px)] bg-no-repeat bg-center bg-cover relative z-0 after:bg-black after:absolute after:top-0 after:left-0 after:h-full after:w-full after:bg-opacity-50 after:z-[-1]">
