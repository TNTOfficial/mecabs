...
import { Autoplay, Navigation, EffectFade, Pagination, Parallax } from "swiper/modules";
    ...
    <Swiper
      ...
      onInit={(swiper) => {
        for (let i = 0; i < swiper.slides.length; i++) {
          swiper.slides[i].querySelector('.slide-bg')?.setAttribute(
        ...
        <div className="container">
          <div className="max-w-screen-xl px-3 mx-auto h-[calc(90dvh_-_64px)] py-[100px] flex justify-center items-start flex-col">
            <div className="sectionHeading pb-[100px]">
              ...
              <h4 data-swiper-parallax="-1000" className="text-white text-[1.3rem] font-bold">
                Where Wd You Like To Go?
              </h4>
              <h1 data-swiper-parallax="-2000" className="text-white text-[3rem] font-extrabold">
